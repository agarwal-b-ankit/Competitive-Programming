...
#define numberOfHighBits(S) __builtin_popcount(S)   //using inbuilt function
...
int main() {
    ...
    printf("9. Number of High bits (1) in a number\n");
    S = 117; printSet(S);
    printf("Number of high bits = %d\n",numberOfHighBits(S));
    printf("\n");

    printf("10. Other tricks (not shown in the book)\n");
    printf("8 %c 4 = %d\n", '%', modulo(8, 4));
    printf("7 %c 4 = %d\n", '%', modulo(7, 4));
    printf("6 %c 4 = %d\n", '%', modulo(6, 4));
    printf("5 %c 4 = %d\n", '%', modulo(5, 4));
